  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="w-full min-h-screen relative flex items-center justify-center overflow-hidden">
        ...
        {/* Gradient overlays */}
        <div className="absolute inset-0 bg-gradient-to-t from-background/70 via-background/40 to-background/20"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4 pt-4">
                <Link 
                  href="https://github.com/TahaKhan8899" 
                  target="_blank"
                ...
                <Link 
                  href="https://www.linkedin.com/in/taha-khan8/" 
                  target="_blank"
                  className="text-muted-foreground hover:text-white transition-colors"
                  aria-label="LinkedIn"
                >
            ...
            {/* Right column - Image */}
            <div className="relative w-full aspect-square max-w-[280px] md:max-w-[320px] mx-auto lg:max-w-[360px]">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/30 via-purple-500/30 to-cyan-500/30 rounded-full blur-3xl"></div>
